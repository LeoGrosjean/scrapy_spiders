...
from scraper.spiders.template.base import SitemapDistributeurListSpider


class LeclercSpider(SitemapDistributeurListSpider):
    name = 'leclerc'
    brand_slug = name
    allowed_domains = ['www.e-leclerc.com']
    sitemap_urls = ['https://www.e-leclerc.com/robots.txt']
    distributeur_url_pattern = '/[-a-z0-9]+/infos-magasins$'
